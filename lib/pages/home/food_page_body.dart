                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SmallText(text: "With chinese cahracteristics"),
                            SizedBox(height: Dimensions.height10,),
                            Row(
      ...
      child: Stack(
        children: [
          Container(
            ...
            decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.radius30), color: index.isEven ? Color(0xFF69c5df) : Color(0xFF9294cc), image: DecorationImage(fit: BoxFit.cover, image: AssetImage("assets/image/food0.png"))),
          ),
          Align(
